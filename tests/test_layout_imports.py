...
def test_generation_entrypoint_exists():
    ...
    assert callable(generate_refutation)
...
def test_harvester_reexports_same_entrypoint():
    ...
    from agents.generate import generate_refutation as canonical
    try:
    ...
    assert getattr(core, "generate_refutation", None) is canonical
