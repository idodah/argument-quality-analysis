...
# the few external services it needs (Tavily, Telegram, the Fediverse APIs) goes via a
...
# The task: all egress allowed (it needs NAT egress to Tavily/Telegram/Fediverse and
